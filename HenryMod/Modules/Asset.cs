...
namespace SpaceMarines.Modules
{
    internal static class Asset
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            try
            {
                assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(SpaceMarinesPlugin.instance.Info.Location), "AssetBundles", bundleName));
            }
        ...
        {
            GameObject newPrefab = PrefabAPI.InstantiateClone(RoR2.LegacyResourcesAPI.Load<GameObject>("Prefabs/Projectiles/" + prefabName), newPrefabName, false);
            return newPrefab;
        }
